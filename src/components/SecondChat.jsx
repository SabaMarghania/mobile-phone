...
function Chat() {
    ...
    useEffect(() => {
        ...
        db.collection('secmessages').orderBy('timestamp', 'asc').onSnapshot(snapshot => {
            setSecMessages(snapshot.docs.map(doc => ({ id: doc.id, data: doc.data()})))
          })
      }, [])
      const HandleMessage =(e)=>{
          e.preventDefault();
          db.collection('secmessages').add({
