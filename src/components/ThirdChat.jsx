...
function Chat() {
    ...
    useEffect(() => {
        ...
        db.collection('thirdmessages').orderBy('timestamp', 'asc').onSnapshot(snapshot => {
            setThirdMessages(snapshot.docs.map(doc => ({ id: doc.id, data: doc.data()})))
          })
      }, [])
      const HandleMessage =(e)=>{
          e.preventDefault();
          db.collection('thirdmessages').add({
